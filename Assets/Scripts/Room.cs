...
public class Room : MonoBehaviour
{
    ...
    public GameObject panelext;
    public GameObject panelint;
    public GameObject[] lights;
    public GameObject[] clue;
    public AudioClip message;

    public bool fruitCodes = false; // specific code for fruit level
    public bool isBinaryDoor = false; // Si coché, cette porte s'ouvre avec 1 et se ferme avec 0
    ...
    public void setlightcolor(Color color)
    {
        ...
        {
            var lightMaterial = light.GetComponent<Renderer>().material;
    ...
    public void OpenDoor()
    {
        ...
        {          
            ...
            if(isBinaryDoor) setlightcolor(Color.green);
        }
        if (doorState == DOOR_STATE.OPEN)
        {
            ...
            startTimeOfDoorState = Time.time;
            door.GetComponent<AudioSource>().Play();
            if(isBinaryDoor) setlightcolor(Color.red);
        }
    }
